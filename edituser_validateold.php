<?php
	...
	if (isset($_POST['btn_submit'])){
		...
		else
		{
			...
			if (count($errors)==0){
			$query_insPrivilege ="UPDATE privilege SET fname='$fname', lname='$lname', userName='$usrname', email='$usrEmail', userType='$type', staffId='$staffId' WHERE userId='$_POST[userid]'";
